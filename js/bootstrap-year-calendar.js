 ...
 * ========================================================= */
 ...
 (function($) {
	...
	Calendar.prototype = {
		...
		_initializeOptions: function(opt) {
			...
			this.options = {
				...
				roundRangeLimits: opt.roundRangeLimits != null ? opt.roundRangeLimits : true,
		...
		_renderBody: function() {
			...
			let yeartitle = $('.year-title:not(.year-neighbor, .year-neighbor2)').text();
			let numyeartitle = Number(yeartitle);
			//console.log(numyeartitle);
			...
			switch(this.options.style)
			{
				case 'border':
					...
					if(events.length == 1) {
						...
						elt.parent().css('background-color', 'black');
					}
					...
					if(weight > 0)
					{
						...
						elt.parent().css('background-color', backgroundColor);
					}
					break;
	...
	var colors = $.fn.calendar.colors = ['rgba(235, 183, 0, .15)', 'rgba(63, 169, 245, .15)', 'rgba(61, 192, 39, .15)', 'rgba(210, 139, 236, 1)', 'rgba(242, 101, 35, 1)', 'rgba(243, 233, 248, 1)'];
